...
#' @author Yuning Hao, Ming Yan, Yu Lei and Yuying Xie
#' @references Yuning Hao, Ming Yan, Yu Lei and Yuying Xie. Fast and Robust Deconvolution of Tumor Infiltrating Lymphocyte from Expression Profiles using Least Trimmed Squares.
#' @examples
#' library(FARDEEP)
#' data(LM22)
#' data(mixture)
#' result = fardeep(LM22, mixture, alpha1 = 0.1, alpha2 = 1.5, up = 10, low = 1, nn = TRUE, intercept = TRUE, lognorm = TRUE, permn = 100, QN = FALSE)
